...
functions as values this language:
...
The following is a further explanation of how function arguments work when function literals are generic and untyped.

# Function arguments, rather than being a basic syntax, are sugar for the basic case.
